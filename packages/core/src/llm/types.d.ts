 ...
 */
export type AgentRole = 'architect' | 'coder' | 'reviewer' | 'tester' | 'diagnoser' | 'documenter';
/**
 ...
 */
export type RetryCondition = 'rate_limit' | 'timeout' | 'server_error' | 'invalid_response' | 'parse_error';
/**
