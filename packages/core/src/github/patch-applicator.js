...
exports.applyDiffToContent = applyDiffToContent;
exports.extractFileChangesFromDiff = extractFileChangesFromDiff;
const diff_parser_1 = require("../policy/diff-parser");
// ============================================================================
 ...
 */
function extractFileChangesFromDiff(diff) {
    const files = [];
...
class PatchApplicator {
            ...
            for (const patch of patchSet.patches) {
                ...
                for (const change of fileChanges) {
                    ...
                    if (change.isNew) {
                        ...
                        try {
                            const currentFile = await this.writeGate.getFileContents(owner, repo, change.path, branchName);
     ...
     */
    generateBranchName(workflowId, patchSetId) {
     ...
     */
    generatePRBody(patchSet, workflowId) {
        const lines = [
            '## Summary',
            '',
     ...
     */
    extractNewFileContent(diffContent) {
...
//# sourceMappingURL=patch-applicator.js.map